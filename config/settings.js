...
const WEBSITE_PIN = "2104";              // ← GANTI PIN

/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   2. NAMA PENERIMA
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Nama yang muncul di halaman utama (hero).                      */
const RECIPIENT_NAME = "Vania Vanyaa";           // ← GANTI NAMA
...
const MUSIC_TRACKS = [
  {
    title:  "Mirrors",             // ← GANTI JUDUL LAGU
    artist: "Justin Timberlake",                   // ← GANTI NAMA ARTIS
...
const LETTER_PARAGRAPHS = [
  "Happy Birthday wanita hebat, kuat, kong kabal 😘🤍 Makase so jadi inspirasi deng jadi berkat for orang-orang di sekitar. Kehadiran ade tuh bukan cuma bikin orang senang, tapi juga kasih semangat buat banyak orang. Nda semua orang bisa punya hati sebaik dan sekuat ade, makanya aku bangga banget bisa kenal ade.",
  "Makase so tetap kuat lewati semua hal yang ade hadapi sampai hari ini. Aku tau nda semua perjalanan selalu mudah, tapi ade selalu bisa jalan terus walaupun banyak tantangan. Itu yang bikin ade luar biasa. Tetap jadi wanita hebat yang selalu kasih energi positif buat orang-orang di sekitar yaa. 🔥🤍",
  "Di umur yang baru ini, semoga tiap langkah ade selalu diberkati, diberi kekuatan, kesehatan, dan kebahagiaan yang melimpah. Semoga semua yang ade harapkan bisa berjalan lancar satu per satu, dan semua doa-doa baik yang ade simpan bisa dijawab di waktu yang paling indah. Semoga rezeki, sukacita, dan damai selalu ikut dalam setiap perjalanan ade.",
  "Yang paling penting, semoga ade selalu ada dalam lindungan Tuhan. Tuhan sayang ade, Tuhan jaga ade terus dalam setiap keadaan. Jangan pernah ragu sama diri sendiri, karena ade lebih kuat dan lebih hebat dari yang ade kira. Love you more, wanita hebatku 🤍😇✨",
];
